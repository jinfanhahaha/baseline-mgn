...
class MGN(nn.Module):
    ...
    def forward(self, batched_inputs):
        ...
        return (b1_logits, b2_logits, b21_logits, b22_logits, b3_logits, b31_logits, b32_logits, b33_logits,
                ...
                torch.cat((b31_pool_feat, b32_pool_feat, b33_pool_feat), dim=1), pred_class_logits)
    ...
    def get_features(self, batched_inputs):
        ...
        b1_pool_feat = b1_pool_feat.squeeze(dim=2)
        b1_pool_feat = b1_pool_feat.squeeze(dim=2)
        b2_pool_feat = b2_pool_feat.squeeze(dim=2)
        b2_pool_feat = b2_pool_feat.squeeze(dim=2)

        b21_pool_feat = b21_pool_feat.squeeze(dim=2)
        b21_pool_feat = b21_pool_feat.squeeze(dim=2)
        b22_pool_feat = b22_pool_feat.squeeze(dim=2)
        b22_pool_feat = b22_pool_feat.squeeze(dim=2)

        b3_pool_feat = b3_pool_feat.squeeze(dim=2)
        b3_pool_feat = b3_pool_feat.squeeze(dim=2)
        b31_pool_feat = b31_pool_feat.squeeze(dim=2)
        b31_pool_feat = b31_pool_feat.squeeze(dim=2)

        b32_pool_feat = b32_pool_feat.squeeze(dim=2)
        b32_pool_feat = b32_pool_feat.squeeze(dim=2)
        b33_pool_feat = b33_pool_feat.squeeze(dim=2)
        b33_pool_feat = b33_pool_feat.squeeze(dim=2)

        # print(b1_pool_feat.shape)
        # print(b2_pool_feat.shape)
        # print(b3_pool_feat.shape)
        # print(b21_pool_feat.shape)
        # print(b22_pool_feat.shape)
        # print(b31_pool_feat.shape)
        # print(b32_pool_feat.shape)
        # print(b33_pool_feat.shape)
        haha_add = b1_pool_feat+b2_pool_feat+b3_pool_feat+b21_pool_feat+b22_pool_feat+b31_pool_feat+b32_pool_feat+b33_pool_feat

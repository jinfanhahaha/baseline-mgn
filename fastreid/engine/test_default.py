...
__all__ = ["test_default_argument_parser", "default_setup", "DefaultPredictor", "DefaultTrainer"]
...
def test_default_argument_parser():
    ...
    parser.add_argument("--config-file", default="../configs/Market1501/mgn_R50-ibn.yml", metavar="FILE", help="path to config file")
    parser.add_argument(
        "--resume",
        action="store_true",
    ...
    parser.add_argument("--num-machines", type=int, default=0, help="total number of machines")
    parser.add_argument(
